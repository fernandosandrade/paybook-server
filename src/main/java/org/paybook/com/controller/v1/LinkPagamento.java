...
public class LinkPagamento {
     ...
     * <p>Para incluir um novo link de pagamento a uma cobranca, a
     * mesma deve estar em {@link EnumStatusCobranca#CHARGE_OPEN} ou {@link EnumStatusCobranca#WAITING_PAYMENT}. A soma
     * dos links de pagamento para uma cobranca nao podem ser superiores ao valor total da cobranca, mas podem ser
     * inferiores. O prazo máximo de expiracao do link de pagamento é o prazo maximo da cobrança.</p>
     *
