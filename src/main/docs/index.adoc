...
Cada link de uma corança pode ser considerado uma *parcela* Quando o link é pago, a cobrança pode ser encerrar, no caso de cobrança única, ou não, no caso de cobrança parcelada em mais de um link ou cobrança recorrente, onde os links são gerados de forma periódica.
...
Toda cobrança possui 1 ou multiplos links de pagamento.
...
Além disso, possui o id da cobrança pai e o id do destinatario.
...
Em caso de cobranças recorrentes, a quitação fica restrita apenas a parcela, mantendo a cobrança como ATIVA. Para maiores detalhes a respeito do fluxo das cobranças, consultar cada tipo em específico.
